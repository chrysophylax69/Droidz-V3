...
int nAnonymizeDroidzAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Droidz
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Droidz
    // Mac: ~/Library/Application Support/Droidz
    // Unix: ~/.droidz
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Droidz2";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "droidz.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "droidzd.pid"));
